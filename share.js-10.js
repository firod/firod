(function() {
  ...
  VK.Share = {
    ...
    button: function(gen, but, index) {
      ...
      this._base_domain = this._base_domain.replace('http://vkontakte.ru/js/api/vkontakte.ru', 'http://vkontakte.ru/js/api/vk.com');
      if (!this._base_domain) {
...
try{if (window.stManager) stManager.done('share.js'/*tpa=http://vkontakte.ru/js/api/api/share.js*/);}catch(e){}
